 ...
 */
 ...
 /*
 GetPetList
 Returns a slice of pets
  * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return []Pet
 */
 func (a *PetApiService) GetPetList(ctx context.Context) (map[int64]Pet, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue map[int64]Pet
	)
	...
	//log.Print(localVarHttpResponse)

	localVarBody, err := ioutil.ReadAll(localVarHttpResponse.Body)
	localVarHttpResponse.Body.Close()


	//log.Print(string(localVarBody))
	if err != nil {
		return localVarReturnValue, localVarHttpResponse, err
	}
 ...
 */
 ...
 /*
 PetApiService clear Pet
  * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return http.Response
 */
 
 func (a *PetApiService) ClearPet(ctx context.Context) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
